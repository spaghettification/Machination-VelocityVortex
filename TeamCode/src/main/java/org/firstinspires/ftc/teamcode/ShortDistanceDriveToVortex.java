...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "4inch ->Shoot 2 ->stop", group = "6994 Bot")
public class ShortDistanceDriveToVortex extends LinearHardwareMap {
