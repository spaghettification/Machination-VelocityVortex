...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "6inch-> Shoot 2 -> BackUp", group = "6994 Bot")
public class ShortDistanceThenBackUp extends LinearHardwareMap {
